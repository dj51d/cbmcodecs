""" Python Character Mapping Codec petscii_c64en_lc generated from 'mappings/petscii_c64en_lc.txt' with gencodec.py.
...
decoding_table = (
    ...
    '\uf134'    #  0xAC -> BLACK SMALL SQUARE LOWER RIGHT (CUS)
    ...
    '\u2713'    #  0xBA -> CHECK MARK
    '\uf135'    #  0xBB -> BLACK SMALL SQUARE LOWER LEFT (CUS)
    '\uf136'    #  0xBC -> BLACK SMALL SQUARE UPPER RIGHT (CUS)
    ...
    '\uf134'    #  0xEC -> BLACK SMALL SQUARE LOWER RIGHT (CUS)
    ...
    '\u2713'    #  0xFA -> CHECK MARK
    '\uf135'    #  0xFB -> BLACK SMALL SQUARE LOWER LEFT (CUS)
    '\uf136'    #  0xFC -> BLACK SMALL SQUARE UPPER RIGHT (CUS)
    '\u2518'    #  0xFD -> BOX DRAWINGS LIGHT UP AND LEFT
    '\uf137'    #  0xFE -> BLACK SMALL SQUARE UPPER LEFT (CUS)
    '\u2592'    #  0xFF -> MEDIUM SHADE
)
